# Notice
This folder contains the orginal code we referred to ('emotions.py') and the code that and the modified version ('FaceAndEmotionDetection_v2.py')that we used for the contest. The following contents were copied from the original readme file.
